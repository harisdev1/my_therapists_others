...
class BooothOwnerAppointmentScreen extends StatelessWidget {
  const BooothOwnerAppointmentScreen({Key? key}) : super(key: key);
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  CustomText(fontSize: 22, text: "Past Appointments"),
                ],
              ),
